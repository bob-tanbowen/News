...
var l1F=_mz(z,'mix-advert',['bind:__l',1,'class',1,'data-ref',2,'imageUrl',3,'timedown',4,'url',5,'vueId',6],[],e,s,gg)
_(oZF,l1F)
var a2F=_mz(z,'scroll-view',['scrollWithAnimation',-1,'scrollX',-1,'class',8,'id',1,'scrollLeft',2],[],e,s,gg)
var t3F=_v()
_(a2F,t3F)
var e4F=function(o6F,b5F,x7F,gg){
var f9F=_mz(z,'view',['bindtap',15,'class',1,'data-event-opts',2,'id',3],[],o6F,b5F,gg)
var c0F=_oz(z,19,o6F,b5F,gg)
_(f9F,c0F)
_(x7F,f9F)
return x7F
}
...
_(oZF,a2F)
var hAG=_mz(z,'mix-pulldown-refresh',['bind:__l',20,'bind:refresh',1,'bind:setEnableScroll',2,'class',3,'data-event-opts',4,'data-ref',5,'top',6,'vueId',7,'vueSlots',8],[],e,s,gg)
var oBG=_mz(z,'swiper',['bindchange',29,'class',1,'current',2,'data-event-opts',3,'duration',4,'id',5],[],e,s,gg)
var cCG=_v()
_(oBG,cCG)
var oDG=function(aFG,lEG,tGG,gg){
var bIG=_n('swiper-item')
var oJG=_mz(z,'scroll-view',['bindscrolltolower',39,'class',1,'data-event-opts',2,'scrollY',3],[],aFG,lEG,gg)
var xKG=_v()
_(oJG,xKG)
var oLG=function(cNG,fMG,hOG,gg){
var cQG=_mz(z,'view',['bindtap',47,'class',1,'data-event-opts',2],[],cNG,fMG,gg)
var lSG=_n('text')
_rz(z,lSG,'class',50,cNG,fMG,gg)
var aTG=_oz(z,51,cNG,fMG,gg)
_(lSG,aTG)
_(cQG,lSG)
var oRG=_v()
_(cQG,oRG)
if(_oz(z,52,cNG,fMG,gg)){oRG.wxVkey=1
var tUG=_n('view')
_rz(z,tUG,'class',53,cNG,fMG,gg)
var eVG=_v()
_(tUG,eVG)
var bWG=function(xYG,oXG,oZG,gg){
var c2G=_n('view')
_rz(z,c2G,'class',58,xYG,oXG,gg)
var o4G=_mz(z,'image',['class',59,'src',1],[],xYG,oXG,gg)
_(c2G,o4G)
var h3G=_v()
_(c2G,h3G)
if(_oz(z,61,xYG,oXG,gg)){h3G.wxVkey=1
var c5G=_n('view')
_rz(z,c5G,'class',62,xYG,oXG,gg)
var o6G=_mz(z,'image',['class',63,'src',1],[],xYG,oXG,gg)
_(c5G,o6G)
_(h3G,c5G)
}
h3G.wxXCkey=1
...
eVG.wxXCkey=2
_2z(z,56,bWG,cNG,fMG,gg,eVG,'imgItem','imgIndex','imgIndex')
_(oRG,tUG)
}
else{oRG.wxVkey=2
var l7G=_n('view')
_rz(z,l7G,'class',65,cNG,fMG,gg)
_(oRG,l7G)
}
var a8G=_n('view')
_rz(z,a8G,'class',66,cNG,fMG,gg)
var t9G=_n('text')
_rz(z,t9G,'class',67,cNG,fMG,gg)
var e0G=_oz(z,68,cNG,fMG,gg)
_(t9G,e0G)
_(a8G,t9G)
var bAH=_n('text')
_rz(z,bAH,'class',69,cNG,fMG,gg)
var oBH=_oz(z,70,cNG,fMG,gg)
_(bAH,oBH)
_(a8G,bAH)
_(cQG,a8G)
oRG.wxXCkey=1
...
xKG.wxXCkey=2
_2z(z,45,oLG,aFG,lEG,gg,xKG,'item','index','index')
var xCH=_mz(z,'mix-load-more',['bind:__l',71,'status',1,'vueId',2],[],aFG,lEG,gg)
_(oJG,xCH)
_(bIG,oJG)
_(tGG,bIG)
return tGG
...
cCG.wxXCkey=4
_2z(z,37,oDG,e,s,gg,cCG,'tabItem','__i0__','id')
_(hAG,oBG)
_(oZF,hAG)
_(r,oZF)
return r
